...
of the desired output. This length should be in the range 1-n, where len is the output size of the hash function in bytes as per table [table: HMAC: mechanisms and hash functions]. Signatures (MACs)
...
+==============================:+:===============:+:=======================:+
| CKM_SHA1_HMAC_GENERAL         | SHA-1 (1)       | 20                      |
+-------------------------------+-----------------+-------------------------+
...
It has no parameter, and always produces an output of length as per table [table: HMAC: mechanisms and hash functions].
